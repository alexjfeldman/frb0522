...
import com.idealista.fpe.config.basic.Numeric;
...
public class Default_Numeric implements Serializable {

    private Default_Numeric(){}

    public static final Numeric ALPHABET = new Numeric();
