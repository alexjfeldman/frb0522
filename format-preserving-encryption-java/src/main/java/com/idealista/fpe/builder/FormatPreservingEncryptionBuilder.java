...
import com.idealista.fpe.config.Default_Numeric;
import com.idealista.fpe.config.Default_AllCharacter;
import com.idealista.fpe.config.Default_SocialSecurityNumberWithDashes;
import com.idealista.fpe.config.Domain;
import com.idealista.fpe.config.LengthRange;

import java.io.Serializable;

public class FormatPreservingEncryptionBuilder implements Serializable {
    ...
    private static class WithDomainStep implements WithDomain {
        ...
        @Override
        public WithPseudoRandomFunction withNumericDomain() {
            return withDomain(Default_Numeric.DOMAIN);
        }

        @Override
        public WithPseudoRandomFunction withAllCharacterDomain() {
            return withDomain(Default_AllCharacter.DOMAIN);
        }

        @Override
        public WithPseudoRandomFunction withSocialSecurityNumberWithDashesDomain() {
            return withDomain(Default_SocialSecurityNumberWithDashes.DOMAIN);
        }
    }
