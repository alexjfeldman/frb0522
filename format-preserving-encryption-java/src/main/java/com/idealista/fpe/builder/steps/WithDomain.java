...
public interface WithDomain {
    ...
    WithPseudoRandomFunction withNumericDomain();

    WithPseudoRandomFunction withSocialSecurityNumberWithDashesDomain();

    WithPseudoRandomFunction withAllCharacterDomain();
}
